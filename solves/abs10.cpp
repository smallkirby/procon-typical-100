...
int main(void)
{
  ...
  // main
  while (!S.empty()) {
    if (S.rfind("dreamerase", 0) == 0) S.erase(S.begin(), S.begin() + 5);
    else if (S.rfind("dreamer", 0) == 0) S.erase(S.begin(), S.begin() + 7);
    else if (S.rfind("dream", 0) == 0) S.erase(S.begin(), S.begin() + 5);
    else if (S.rfind("eraser", 0) == 0) S.erase(S.begin(), S.begin() + 6);
    else if (S.rfind("erase", 0) == 0) S.erase(S.begin(), S.begin() + 5);
    else {
      cout << "NO" << endl;
      return 0;
    }
